...
public class ControllerFormDetailTamTru implements Initializable {
	...
	private ModelTamTru data;
	private ModelNhanKhau nguoiDangKy;
	private static ControllerTamTruTamVang controllerTamTru;
	...
	public void editTamTru() {
		...
		if (Connector.editTamTru(data)) {
			labelThongBao.getStyleClass().add("notice-green");
			labelThongBao.setText("Đã lưu thay đổi");

			controllerTamTru.refreshTamTru();
		}
	}
	
	@FXML
	public void deleteTamTru() {
		...
		if(result.isPresent() && result.get() == ButtonType.OK) {
			if(Connector.deleteTamTru(data)) {
				controllerTamTru.refreshTamTru();
				App.closeStageForm();
			}
		}	
	...
	public static ControllerTamTruTamVang getControllerTamTruTamVang() {
		return controllerTamTru;
	}
	
	public static void setControllerTamTruTamVang(ControllerTamTruTamVang controllerTamTru) {
		ControllerFormDetailTamTru.controllerTamTru = controllerTamTru;
	}
}
